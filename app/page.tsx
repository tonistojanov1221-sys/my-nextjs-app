...
const initialProducts: Product[] = [
  ...
  {
    name: "Crayola Classic Crayons 24-Count Box",
    category: "Classroom",
    price: "$2.79",
    score: "9.8",
    description: "Non-toxic classic school crayons designed for smooth coloring and classroom creativity.",
